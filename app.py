    ...
    if fc_report and enable_fact_check:
        ...
        if has_corrections:
            ...
            <div class="fc-corrections-banner">
                💡 <strong>L'article ci-dessous intègre déjà toutes les corrections.</strong> Le rapport détaillé ci-dessous liste ce qui a été modifié par rapport à la version initiale — vous n'avez rien à reprendre, c'est pour votre information.
            </div>
            """, unsafe_allow_html=True)
        else:
            st.markdown(f"""
